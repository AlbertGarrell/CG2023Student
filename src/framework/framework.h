...
class Matrix44
{
	public:
		...
		void Scale(float x, float y, float z); //creat per nos
		void Rotate( float angle_in_rad, const Vector3& axis  );

		// Transform using local coordinates
		void TranslateLocal(float x, float y, float z);
		void ScaleLocal(float x, float y, float z);//creat per nos
		...
		void SetScale(float x, float y, float z);//creat per nos
